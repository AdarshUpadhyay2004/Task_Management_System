...
# Useful when running behind HTTPS on a custom domain (ngrok, reverse proxy, etc.)
...
MIDDLEWARE = [
    ...
    'accounts.middleware.CurrentRoleMiddleware',
    'tasks.middleware.CurrentUserActivityMiddleware',
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "no-reply@taskmanager.local")
